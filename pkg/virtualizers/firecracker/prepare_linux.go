...
func (o *operation) InitializeDownloadVMLinux() (int, error) {
...
func (o *operation) fetchVMLinux(kernel string) (string, error) {
	...
	if err != nil {
		length, err := o.InitializeDownloadVMLinux()
		if err != nil {
			return "", err
		}
		// Make request
...
func (o *operation) makeInterfaces() {
...
func (o *operation) generateFirecrackerConfig() (*firecracker.Config, []firecracker.Opt, error) {
	logger := log.New()
	...
	o.tapDevice = CreateTapDevices(o.id, len(o.routes))
...
func (o *operation) prepare(args *virtualizers.PrepareArgs) {
	...
	o.fconfig, o.machineOpts = o.generateFirecrackerConfig()
	o.gctx = ctx
	o.vmmCtx = vmmCtx
